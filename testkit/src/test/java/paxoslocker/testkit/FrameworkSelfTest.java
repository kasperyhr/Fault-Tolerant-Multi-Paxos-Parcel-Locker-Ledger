...
class FrameworkSelfTest {
    ...
    @Test void a5CheckUsesKnownBallotOrdering(){var c=new SafetyInvariantChecker();var chosen=new NoOp(UUID.randomUUID());var earlier=new NoOp(UUID.randomUUID());c.observeChosen(new BallotNumber(2,"L1"),1,chosen);assertDoesNotThrow(()->c.observeAccepted(A1,new BallotNumber(1,"L1"),1,earlier));assertThrows(SafetyViolationException.class,()->c.observeAccepted(A2,new BallotNumber(3,"L2"),1,earlier));}
    ...
    private static final class FakeAcceptor extends Acceptor {
        ...
        @Override public P1bMessage onP1a(P1aMessage m){return new P1bMessage(A1,m.ballot(),Set.of());}
